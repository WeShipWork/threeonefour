...
const piAiEntry = fileURLToPath(new URL("./node_modules/@earendil-works/pi-ai/dist/index.js", import.meta.url));
...
export default defineConfig({
  ...
  resolve: {
    alias: [{ find: /^@earendil-works\/pi-ai$/, replacement: piAiEntry }],
