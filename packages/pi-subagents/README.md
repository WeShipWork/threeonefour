...
Fork of [`@tintinweb/pi-subagents`](https://github.com/tintinweb/pi-subagents) published for WeShip.work Mirror mode. It is a [Pi](https://pi.dev) extension that brings **Claude Code-style autonomous sub-agents** to pi. Spawn specialized agents that run in isolated sessions — each with its own tools, system prompt, model, and thinking level. Run them in foreground or background, steer them mid-run, resume completed sessions, and define your own custom agent types.

> **Status:** Early release fork. Use `@weshipwork/pi-subagents` for Mirror mode with `@weshipwork/pi-herd`; use the upstream package only if you do not need the WeShip.work mirror observation seam.
...
pi update npm:@weshipwork/pi-subagents
pi remove npm:@weshipwork/pi-subagents
```

For Mirror mode in Herdr, install `@weshipwork/pi-herd` alongside this package:
...
MIT — fork maintained by [WeShip.work](https://github.com/WeShipWork); original package by [tintinweb](https://github.com/tintinweb)
